...
<div class='wrapper'>
    ...
    <div>
    <h1>OCD Symptom Tracker - Parent</h1>
</div>
    <form action="process.php" method="post">
        <div><input type="hidden" name="reporter" value="parent"/></div>
...
There are no right or wrong answers.</div>
 ...
 <?php
 $question =  array(1=>10,16, 23, 31, 42, 44);
 ...
 ?>
        <div class='row' id='<?=$key?>'>
            ...
            <div class='cell'>Never:<input type="radio" name='question_<?=$$key?>' value='0'></div>
            <div class='cell'>Sometimes:<input type="radio" name='question_<?=$key?>' value='1'></div>
            <div class='cell'>Often:<input type="radio" name='question_<?=$key?>' value='2'></div>
            <div class='cell'>Always:<input type="radio" name='question_<?=$key?>' value='3'></div>
